...
finish_product_2 = driver.find_element(By.XPATH,"//a[@id='item_5_title_link']")
...
item_total = f"Item total: ${float(str(value_finish_price_product_1)[1:])+float(str(value_finish_price_product_2)[1:])}"
print(item_total)
